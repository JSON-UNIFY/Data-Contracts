...
|    | command            | params                                                                                                                                                                      | date                       |
|---:|:-------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------------------------|
|  0 | Source file loaded |                                                                                                                                                                             | 2022-12-12 15:51:20.908459 |
|  1 | unify.query()      | meta select {'col': 'key', 'target': 'source'}                                                                                                                              | 2022-12-12 15:51:20.908690 |
|  2 | unify.query()      | meta update [{'row': 3, 'col': 'value', 'set': 'https://raw.githubusercontent.com/JSON-UNIFY/Data-Contracts/main/AAPL.csv'}]                                                | 2022-12-12 15:51:20.908718 |
|  3 | unify.query()      | headers update [{'row': 0, 'col': 'type', 'set': 'string'}, {'row': 0, 'col': 'description', 'set': 'The data of the transactions'}]                                        | 2022-12-12 15:52:17.136541 |
|  4 | unify.query()      | headers update [{'row': 1, 'col': 'type', 'set': 'float'}, {'row': 1, 'col': 'description', 'set': 'The price for a share when the market opens'}]                          | 2022-12-12 15:52:17.136704 |
|  5 | unify.query()      | headers update [{'row': 2, 'col': 'type', 'set': 'float'}, {'row': 2, 'col': 'description', 'set': 'The highest price for a share during the trading day'}]                 | 2022-12-12 15:52:17.136805 |
|  6 | unify.query()      | headers update [{'row': 3, 'col': 'type', 'set': 'float'}, {'row': 3, 'col': 'description', 'set': 'The lowest price for a share during the trading day'}]                  | 2022-12-12 15:52:17.136926 |
|  7 | unify.query()      | headers update [{'row': 4, 'col': 'type', 'set': 'float'}, {'row': 4, 'col': 'description', 'set': 'The closing price for a share at the end of the trading day'}]          | 2022-12-12 15:52:17.137029 |
|  8 | unify.query()      | headers update [{'row': 5, 'col': 'type', 'set': 'float'}, {'row': 5, 'col': 'description', 'set': 'The adjusted closing price for a share at the end of the trading day'}] | 2022-12-12 15:52:17.137121 |
|  9 | unify.query()      | headers update [{'row': 6, 'col': 'type', 'set': 'int'}, {'row': 6, 'col': 'description', 'set': 'The amount of shares that were exchanged on the day'}]                    | 2022-12-12 15:52:17.137212 |
| 10 | unify.query()      | meta update [{'row': 7, 'col': 'value', 'set': 'Yahoo Finance'}, {'row': 10, 'col': 'value', 'set': 'Trading data for Apple'}]                                              | 2022-12-12 15:52:17.137299 |
| 11 | unify.query()      | meta delete [{'rows': [4, 5, 6, 8, 9, 11]}]                                                                                                                                 | 2022-12-12 15:52:17.137396 |
| 12 | unify.query()      | meta insert [{'key': 'documentation', 'value': 'https://my_site.com/xyz...'}]                                                                                               | 2022-12-12 15:52:17.137497 |
| 13 | unify.query()      | sla insert [{'category': 'service response time', 'provider': True, 'customer': False, 'requirement': 'All service requests answered within 24 hours'}]                     | 2022-12-12 15:52:17.137590 |
| 14 | unify.query()      | features insert [{'column': 'Open', 'row': '3', 'table': 'data', 'relation': 'Share Price', 'description': 'Highest ever'}]                                                 | 2022-12-12 15:52:17.137687 |
| 15 | unify.query()      | features insert [{'column': 'Open', 'row': '3', 'table': 'data', 'relation': 'News Events', 'description': 'Apple announces iPhone X'}]                                     | 2022-12-12 15:52:17.137779 |
```
## Data
...
```
{
    ...
    "lineage": {
        ...
        "date": [
            "2022-12-12 15:51:20.908459",
            "2022-12-12 15:51:20.908690",
            "2022-12-12 15:51:20.908718",
            "2022-12-12 15:52:17.136541",
            "2022-12-12 15:52:17.136704",
            "2022-12-12 15:52:17.136805",
            "2022-12-12 15:52:17.136926",
            "2022-12-12 15:52:17.137029",
            "2022-12-12 15:52:17.137121",
            "2022-12-12 15:52:17.137212",
            "2022-12-12 15:52:17.137299",
            "2022-12-12 15:52:17.137396",
            "2022-12-12 15:52:17.137497",
            "2022-12-12 15:52:17.137590",
            "2022-12-12 15:52:17.137687",
            "2022-12-12 15:52:17.137779",
            "2022-12-12 15:54:15.920001"
        ]
    },
    "schema": {
